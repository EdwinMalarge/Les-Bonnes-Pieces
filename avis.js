...
//Récupération des avis en fonction de la pièces
...
export async function afficherGraphiqueAvis() {
    ...
    datasets: [
      {
        ...
        backgroundColor: "rgba(245, 198, 39, 1)",
      },
    ],
  };
  const config = {
  ...
  new Chart(document.querySelector("#graphique-commentaires"), configDispo);
}
